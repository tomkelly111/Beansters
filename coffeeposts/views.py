    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.SUCCESS,
                                 'You have successfully added a Coffee Shop. \
                                  Your post will be visible once it \
             is approved')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.SUCCESS, 'You have \
                                 successfully edited your post, it will \
                                 be visible once it is approved')
            return redirect('home')
    else:
...
def delete_post(request, post_id):
    ...
    if post.author == request.user:
        post.delete()
        messages.add_message(request, messages.INFO, 'Your post has \
